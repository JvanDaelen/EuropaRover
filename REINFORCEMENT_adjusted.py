...
class REINFORCE:
    ...
    def sample_action(self, state: np.ndarray) -> float:
        ...
        #     print(f"\n {action_stddevs = }")
        #     print(f"{state.float() = }")
        #     raise RuntimeError('probably nan error')
        ...
        action = int(torch.argmax(action_means))
...
total_num_episodes = int(5000)  # Total number of episodes og: 5e3
nr_epochs = int(5)
