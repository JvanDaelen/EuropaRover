...
def test_training(training_nr = 0):
    ...
    test_folder = f'results/GlobalTesting/tr78-{training_nr}_gtlo_n1d0DR_1d0RE_0d0ER_0d125DiR_plt10p_net11_noqtp1_SGD_nobatchnorm_noactfundir_diropt1'
    trainer = Trainer()
    max_eps = 100_000
    tot_eps = 0
    eps_batch_size = int(max_eps / 80)
    memory = {
        "rewards": [],
        "actions": [],
        "states": [],
